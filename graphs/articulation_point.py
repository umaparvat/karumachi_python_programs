"""
if root and it has 2 children. it's articulation point. root's parent is -1
if non root vertex(u) and it's children(v) has a backedge to ancenstor of u. then it's a articulation point
"""
